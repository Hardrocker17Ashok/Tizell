...
//         <span className="nav-item" onClick={() => { navigate("/"); setMenuOpen(false); }}>Home</span>

//         {user && (
//           <span className="nav-item" onClick={() => { navigate("/orders"); setMenuOpen(false); }}>
//             Orders
//           </span>
//         )}

//         {user && (
//           <div className="nav-icon-box" onClick={() => { navigate("/notifications"); setMenuOpen(false); }}>
//             <span className="icon">🔔</span>
//             {unread > 0 && <span className="icon-badge">{unread}</span>}
//           </div>
//         )}

//         <div className="nav-icon-box" onClick={() => { navigate("/cart"); setMenuOpen(false); }}>
//           <span className="icon">🛒</span>
...
const Navbar = () => {
  ...
  // CLOSE PROFILE DROPDOWN DESKTOP WHEN CLICK OUTSIDE
  useEffect(() => {
